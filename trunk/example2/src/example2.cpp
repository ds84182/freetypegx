...
int main(int argc, char **argv) {
	...
	FT_UInt fontSize = 64;
	fontSystem->loadFont(rursus_compact_mono_ttf, rursus_compact_mono_ttf_size, fontSize, false);	// Initialize the font system with the external font parameters from example2.s
